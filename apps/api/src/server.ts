...
import { validateEnv, searchEnvSchema, llmEnvSchema, type SearchEnv, type LLMEnv } from '@luma-search/config';
...
const _searchEnv = validateEnv(searchEnvSchema);
const llmEnv = validateEnv(llmEnvSchema);
